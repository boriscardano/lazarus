...
It demonstrates a bug that requires fixing multiple files.
"""
...
def main():
    ...
    # This will trigger the bug - empty list for a product
    print("\n" + "=" * 50)
    ...
    try:
        empty_average = calculate_average([])  # This will fail!
